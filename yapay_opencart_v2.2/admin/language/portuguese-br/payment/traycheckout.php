...
$_['text_traycheckout'] 		= '<a onclick="window.open(\'http://www.traycheckout.com.br/\');"><img src="view/image/payment/traycheckout.gif" alt="Yapay Intermediador" title="TrayCheckout" style="border: 1px solid #EEEEEE;" /></a>';
